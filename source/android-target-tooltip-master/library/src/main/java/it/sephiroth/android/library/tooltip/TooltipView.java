...
class TooltipView extends ViewGroup implements Tooltip {
    ...
    private float arrowLengthWeight;
	...
	public TooltipView(Context context, TooltipManager.Builder builder) {
        ...
        this.arrowLengthWeight = builder.arrowLenghtWeight;
	...
	private void initializeView() {
		...
		if (null != mDrawable) {
            ...
            mDrawable.setGravity(gravity);
            mDrawable.setArrowLengthWeight(arrowLengthWeight);
			...
			if (hideArrow) {
                ...
                if (gravity == TooltipManager.Gravity.BOTTOM) {
                    ...
                    mView.setPadding(padding, (int)(padding*arrowLengthWeight), padding, padding);

                } else if (gravity == TooltipManager.Gravity.TOP) {

                    mView.setPadding(padding, padding, padding, (int)(padding*arrowLengthWeight));

                } else if (gravity == TooltipManager.Gravity.LEFT) {

                    mView.setPadding(padding, padding, (int)(padding*arrowLengthWeight), padding);

                } else if (gravity == TooltipManager.Gravity.RIGHT) {

                    mView.setPadding((int)(padding*arrowLengthWeight), padding, padding, padding);
